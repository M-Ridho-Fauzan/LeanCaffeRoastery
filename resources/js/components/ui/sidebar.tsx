...
>(
	(
		...
		const toggleSidebar = React.useCallback(() => {
			...
			isMobile,
			setOpen,
			// setOpenMobile // setOpenMobile are state setters, no need to include in dependencies
		]);
...
>(({ className, withHandle, enableDrag = true, ...props }, ref) => {
	...
	// Destructure handleTouchStart from useSidebarResize
	const { dragRef, handleMouseDown, handleTouchStart } = useSidebarResize({
		direction: "right",
		enableDrag,
        // enableToggle: true,
		onResize: setWidth,
