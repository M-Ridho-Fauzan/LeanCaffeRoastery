// component/app-sidebar-header.tsx
        ...
        <>
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <Button variant="ghost" size="icon" className="group relative mr-14 h-9 w-9 cursor-pointer" aria-label="Notifications">
                            ...
                            <div className="space-y-6 p-6">
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 gap-x-6 gap-y-4 md:grid-cols-4">
                                        ...
                                        <div className="md:col-span-3">
                                            ...
                                            <p className="text-sm leading-tight font-bold text-[#2D2A6E]">{selectedOrder.customer.address}</p>
                                        </div>
                                        <div>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex items-center justify-between pt-1">
                                            ...
                                            <span className="text-sm font-bold text-[#2D2A6E]">{formatRupiah(selectedOrder.shippingCost)}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-lg font-extrabold text-[#2D2A6E]">
                                        {formatRupiah(
                                            selectedOrder.items.reduce((acc, curr) => acc + curr.price * curr.qty, 0) + selectedOrder.shippingCost,
                                        )}
                                    </span>
                                </div>
